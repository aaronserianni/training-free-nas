"""Convert ELECTRA checkpoint from Tensorflow (as trained on TPUs) to Pytorch for metrids"""
# coding=utf-8
...
from modeling_electra import ElectraForMaskedLM, ElectraForPreTraining, load_tf_weights_in_electra
